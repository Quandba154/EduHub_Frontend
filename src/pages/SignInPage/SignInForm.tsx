...
import { WrapperButtonShare } from "./SignInPageStyle";
      ...
      >
        {({ isSubmitting, handleChange, handleBlur, values, errors }) => (
          <Form className="flex flex-col gap-4 p-4 border w-full h-full border-none ">
            ...
            <h1 className="flex mb-[30px] text-[20px] font-medium">
              Nhập Thông tin tài khoản của bạn !
            </h1>
            <div>
              <label className="flex text-[14px] mb-2 font-bold">Email</label>
              <InputComponent
            ...
            <Checkbox className="!border-[#e9956b] font-medium mt-5">
              Nhớ mật khẩu
            </Checkbox>
            <ButtonComponent
            ...
            <span className="font-bold mt-5">
              Chưa có tài khoản?
              <span className="text-[#e9956b]"> Đăng ký ngay!</span>
            </span>
